...
<details>
    ...
    You can use the command-line tool moby to find synonyms of English words. If you want to format your output and remove any duplicate words, you can use: 
</details>

Like most programmers, I love puzzles. Some of the <a target="_blank" class="ext-link" href="https://enigma.puzzlers.org/">puzzles<span class="text-xs">&nearrow;</span></a> I solve on a regular basis rely on a strong command of the English language. And while I am a native English speaker, synonyms have never been my strong suit. Enter: <a target="_blank" class="ext-link" href="https://github.com/words/moby">Moby<span class="text-xs">&nearrow;</span></a>.

Moby is billed as the "largest English-language thesaurus" and offers a simple command-line interface that can search a local, cached copy from your terminal. Let's see what happens if we query Moby for synonyms of the word "butter" (as in, *"I can't believe it's not butter!"*):
...
### shoving everything into a neat, little script